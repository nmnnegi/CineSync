export const homeData = [
  {
    ...
    rating: 4.7,
    time: "2hr : 22mins",
    desc: "Over a decade after 'gates' connecting worlds appeared, awakening 'hunters' with superpowers, weakest hunter Sung Jinwoo encounters a double dungeon and accepts a mysterious quest, becoming the only one able to level up, changing his fate.",
    starring: "Sung Jinwoo, Chae-in",
    genres: "Action",
    tags: " Action, portal fantasy",
  ...
  },
  {
    ...
    rating: 4.6,
    time: "2hr : 22mins",
    desc: "After his hometown is destroyed, young Eren Jaeger vows to cleanse the earth of the giant humanoid Titans that have brought humanity to the brink of extinction.",
  ...
  {
    id: 3,
    name: "RoadtoHeroMovie",
    rating: 4.8,
    time: "2hr : 22mins",
    desc: "A special that enriches the One Punch Man universe, which is worthwhile and very well executed, providing endless arguments for our protagonist Saitama, to explore his beginnings and his ideals a little more ",
    starring: "Makoto Furukawa, Kaito IshikawaChô",
    genres: "Adventures",
  ...
  },
  {
    ...
    rating: 4.9,
    time: "2hr : 22mins",
    desc: "When a Japanese high schooler comes into possession of a mystical notebook, he finds he has the power to kill anybody whose name he enters in it.",
